...
function optionsframework_admin_head() { 
    ...
    jQuery(function(){
	var message = '<p><a href="<?php echo admin_url('admin.php?page=optionsframework'); ?>">Yönetim panelinden</a> tema ayarlarınızı yapabilir, <a href="<?php echo admin_url('widgets.php'); ?>">tema bileşenlerini</a> kullanarak sitenizi zenginleştirebilirsiniz.</p>';
