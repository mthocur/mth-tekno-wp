...
function optionsframework_add_admin() {
    ...
    $of_page = add_menu_page($themename, 'Tema Paneli', 'edit_theme_options', 'optionsframework','optionsframework_options_page', get_bloginfo('template_url').'/admin/images/panel.png'); // Default
...
<div class="wrap" id="of_container">
  <div id="of-popup-save" class="of-save-popup">
    <div class="of-save-save">Ayarlar Güncellendi</div>
  </div>
  <div id="of-popup-reset" class="of-save-popup">
    <div class="of-save-reset">Ayarlar Sıfırlandı</div>
  </div>
  ...
  <form action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" method="post" style="display:inline;" id="ofform-reset">
    ...
    <input name="reset" type="submit" value="Ayarları Sıfırla" class="button submit-button reset-button" onclick="return confirm('Tüm ayarlar sıfırlansınmı?');" />
...
function optionsframework_uploader_function($id,$std,$mod){
	...
	$uploader .= '<div class="upload_button_div"><span class="button image_upload_button" id="'.$id.'">Resim Yükle</span>';

	if(!empty($upload)) {$hide = '';} else { $hide = 'hide';}

	$uploader .= '<span class="button image_reset_button '. $hide.'" id="reset_'. $id .'" title="' . $id . '">Sil</span>';
	$uploader .='</div>' . "\n";
